...
Ball.destroy_all
Ball.create(bowler:Player.first.id, over_id:Over.last.id, match_id:Match.first.id, delivery:1, runs:1)
Ball.create(bowler:Player.first.id, over_id:Over.last.id, match_id:Match.first.id, delivery:2, runs:0)   
Ball.create(bowler:Player.first.id, over_id:Over.last.id, match_id:Match.first.id, delivery:3, runs:2)   
Ball.create(bowler:Player.first.id, over_id:Over.last.id, match_id:Match.first.id, delivery:4, runs:3)   
Ball.create(bowler:Player.first.id, over_id:Over.last.id, match_id:Match.first.id, delivery:5, runs:0)   
Ball.create(bowler:Player.first.id, over_id:Over.last.id, match_id:Match.first.id, delivery:6, runs:1) 
